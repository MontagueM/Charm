...
public class MainViewModel : INotifyPropertyChanged, IDisposable
{
    ...
    private void ResetCamera(object o)
    {
    ...
    public void Clear()
    {
        ...
        Parallel.ForEach(ModelGroup.GroupNode.Items, node =>
        {
            ...
            {
                Media3D.MeshGeometry3D mesh = mn.Geometry as Media3D.MeshGeometry3D;
                mn.Instances = null;
    ...
    public void SetChildren(List<DisplayPart> parts)
    {
        foreach (var part in parts)
        {
            ...
            Media3D.MeshGeometry3D Model = new Media3D.MeshGeometry3D();
