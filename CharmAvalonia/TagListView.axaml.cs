...
public partial class TagListView : UserControl
{
    ...
    private void OnControlLoaded(object? sender, Avalonia.Interactivity.RoutedEventArgs eventArgs)
    {
    ...
    private void Window_PreviewKeyDown(object? sender, KeyEventArgs keyEventArgs)
    {
    ...
    private void SetItemListByString(string searchStr, bool bPackageSearchAllOverride = false)
    {
        ...
        TrimCheckbox.IsVisible = bShowTrimCheckbox ? true : false;
        ShowNamedCheckbox.IsVisible = bName && bNoName ? true : false;
    ...
    /// </summary>
    private void TagItem_OnClick(object? sender, Avalonia.Interactivity.RoutedEventArgs routedEventArgs)
    {
    ...
    private void TrimCheckbox_OnChecked(object? sender, Avalonia.Interactivity.RoutedEventArgs routedEventArgs)
    {
        _bTrimName = true;
        RefreshItemList();
    }

    private void TrimCheckbox_OnUnchecked(object? sender, Avalonia.Interactivity.RoutedEventArgs routedEventArgs)
    {
        _bTrimName = false;
        RefreshItemList();
    }
    ...
    private void ShowNamedCheckbox_OnChecked(object? sender, Avalonia.Interactivity.RoutedEventArgs routedEventArgs)
    {
        _bShowNamedOnly = true;
        RefreshItemList();
    }

    private void ShowNamedCheckbox_OnUnchecked(object? sender, Avalonia.Interactivity.RoutedEventArgs routedEventArgs)
    {
        _bShowNamedOnly = false;
        RefreshItemList();
    }
    ...
    {
        BulkExportButton.IsVisible = true;
    }
    ...
    private async void BulkExport_OnClick(object? sender, Avalonia.Interactivity.RoutedEventArgs routedEventArgs)
    {
        ...
        var viewer = GetViewer();
        bool bStaticShowing = viewer.StaticControl.IsVisible == true;
        bool bEntityShowing = viewer.EntityControl.IsVisible == true;
        viewer.StaticControl.IsVisible = bStaticShowing ? false : viewer.StaticControl.IsVisible;
        viewer.EntityControl.IsVisible = bEntityShowing ? false : viewer.EntityControl.IsVisible;
        ...
        viewer.StaticControl.IsVisible = bStaticShowing ? true : viewer.StaticControl.IsVisible;
        viewer.EntityControl.IsVisible = bEntityShowing ? true : viewer.EntityControl.IsVisible;
    }
    ...
    private void LoadSoundsPackage(FileHash fileHash)
    {
        SetViewer(TagView.EViewerType.TagList);
        var viewer = GetViewer();
        viewer.MusicPlayer.IsVisible = true;
