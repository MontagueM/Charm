...
public class GlobalStrings : Strategy.StrategistSingleton<GlobalStrings>
{
    ...
    private ConcurrentDictionary<StringHash, List<StringBiasView>> _strings = new();
    private ConcurrentBag<TigerHash> _addedLocalizedStrings = new();
    private ConcurrentBag<TigerHash> _localizedStringsBias = new();
