// ---- Created with 3Dmigoto v1.3.16 on Sat May 17 23:22:11 2025

cbuffer procedural_spinner_pos_scale_constant_buffer : register(b0)
{
    float4 pos_scale : packoffset(c0);
}
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.x = floor(r0.x);
  r0.yz = float2(1080,0.333333343) * v1.yz;
  r0.z = frac(r0.z);
  r0.w = r0.z * -2 + 3;
  r0.z = r0.z * r0.z;
  r0.z = r0.w * r0.z;
  ...
  r6.yz = v1.xy * v0.xy;
    ...
    r7.yz = r6.yz * pos_scale.xy + pos_scale.zw; // Spinner scale + pos
  //r7.yz = r6.yz * float2(2,2) + float2(-1,-1);
