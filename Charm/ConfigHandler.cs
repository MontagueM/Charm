...
public class ConfigHandler
{
    ...
    public static void SetOutputTextureFormat(TextureExportFormat outputTextureFormat)
    {
    ...
    public static TextureExportFormat GetOutputTextureFormat()
    {
        if (_config.AppSettings.Settings["outputTextureFormat"] == null)
        {
    ...
    private static TextureExportFormat FindEnumValue(string description)
    {
